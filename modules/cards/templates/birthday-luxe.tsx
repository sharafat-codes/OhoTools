  ...
  return (
    <div className="bl-stage" style={{ "--gold": gold } as React.CSSProperties}>
      ...
      <div className="bl-content">
        ...
        <div className="bl-eyebrow">✦ Happy Birthday ✦</div>
...
.bl-content{position:relative; z-index:10; padding:40px; max-width:88%;}
.bl-photo{display:block; margin:0 auto 1em; width:clamp(96px,24vw,132px); height:clamp(96px,24vw,132px); border-radius:50%; object-fit:cover;
...
.bl-eyebrow{font-size:clamp(.8rem,2.6vw,1.05rem); letter-spacing:.3em; text-transform:uppercase; color:var(--gold); font-weight:600; animation:bl-in .9s .2s both;}
.bl-name{margin:.2em 0; font-family:Georgia,'Times New Roman',serif; font-weight:700; font-size:clamp(2.8rem,11vw,5.6rem); line-height:1.05;
...
.bl-msg{font-size:clamp(1rem,3.2vw,1.3rem); line-height:1.7; opacity:.9; max-width:34ch; margin:0 auto; font-style:italic; animation:bl-in 1s .7s both; text-wrap:balance;}
.bl-from{margin-top:1.3em; font-size:clamp(.9rem,2.8vw,1.1rem); letter-spacing:.12em; color:var(--gold); animation:bl-in 1s .85s both;}
