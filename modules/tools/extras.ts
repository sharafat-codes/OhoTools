...
export const extraTools: DevTool[] = [
  ...
  },
  {
    ...
    explainer: {
      ...
      body: "A Valentine's card here is a link rather than an object, so it arrives the moment you send it, wherever the person already is, and it can carry things paper cannot: movement, a photo, and words you can rewrite until they are right. You write up to 400 characters, then choose from seven designs and nine colour themes; the default is a rose palette with floating hearts drifting up the screen. Any photo you add is cropped and resized inside your browser, so it never leaves your device, and the whole card is encoded in the link itself rather than stored anywhere. The optional tune plays Pachelbel's Canon in D, synthesized in the browser. Sending costs nothing and there is no limit on how many you make. Pro adds four premium designs, custom colours, removal of the small OhoTool credit, and the ability to download the card as an image or a short video.",
    },
